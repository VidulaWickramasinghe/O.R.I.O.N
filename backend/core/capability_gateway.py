...
CAPABILITY_PLUGIN_OVERRIDES: Dict[str, str] = {
    ...
    "transcribe_voice_audio": "voice_system",
...
API_CAPABILITY_MAP: Dict[str, str] = {
    ...
    "voice_transcribe": "transcribe_voice_audio",
...
INTERNAL_CAPABILITY_MAP: Dict[str, frozenset[str]] = {
    ...
    "core.voice_state.save_voice_state": frozenset({"reset_voice_state", "transcribe_voice_audio", "update_voice_state"}),
    "core.voice_state.update_voice_state": frozenset({"reset_voice_state", "transcribe_voice_audio", "update_voice_state"}),
    "core.voice_transcription.transcribe_audio_bytes": frozenset({"transcribe_voice_audio"}),
