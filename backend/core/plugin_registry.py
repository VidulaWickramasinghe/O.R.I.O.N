...
PLUGIN_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    {"key":"safety_review_board","name":"Safety Review Board","description":"Feature risk scoring, approval decisions, and development eligibility governance.","category":"security","risk_level":"low","permissions":["feature_review","risk_scoring","approval_governance"],"default_enabled":True},
