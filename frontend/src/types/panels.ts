...
export type AuroraPanelId = "dashboard-intelligence" | "dashboard-layout" | "dashboard-view-selector" | "release-candidate" | "stabilization" | "frontend-refactor" | "desktop-shell" | "backend-sidecar" | "plugin-system" | "security-policy" | "tool-permission" | "tool-audit" | "notification-engine" | "user-settings" | "screenshot-gallery" | "portfolio-case-study" | "portfolio-demo" | "portfolio-showcase-status" | "guided-walkthrough" | "presenter-controls";
